...
public class ValueChanel extends Channel {
    public ValueChanel(String name, double value) {
        super(name, ValueType.FLOAT, null);
        setValue(value);
    }

    public ValueChanel(String name, int value) {
        super(name, ValueType.INT, null);
        setValue(value);
    }
